...
GO
PRINT N'Creating primary key [PK_WidgetSupply] on [dbo].[WidgetBookSupply]'
GO
ALTER TABLE [dbo].[WidgetBookSupply] ADD CONSTRAINT [PK_WidgetSupply] PRIMARY KEY CLUSTERED ([BookSupplyID])
GO
